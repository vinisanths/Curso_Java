package TratamentoDeExcecoes.ExSolucaoMuitoRuim.Aplicacao;

import TratamentoDeExcecoes.ExSolucaoMuitoRuim.Modelo.Entidades.Reserva;
    ...
    public static void main(String[] args) throws ParseException {
        ...
        if (!checkOut.after(checkIn)) {
            ...
            if (checkIn.before(agora) || checkOut.before(agora)) {
                System.out.println("Erro na Reserva: Atualizações em datas de Reservas devem ser datas Futuras");
